Rails.application.routes.draw do
  ...
  # root "articles#index"
  get '/register1', to: "user#new", as: :new_user1
  post "/register1", to: "user#create", as: :create_user1
  get '/login1' , to: "user#login", as: :serch_user
  post "/login1", to: "user#serch", as: :find_user
