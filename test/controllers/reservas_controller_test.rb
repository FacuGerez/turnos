...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference("Reserva.count") do
      post reservas_url, params: { reserva: { email: @reserva.email, horario: @reserva.horario } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { email: @reserva.email, horario: @reserva.horario } }
